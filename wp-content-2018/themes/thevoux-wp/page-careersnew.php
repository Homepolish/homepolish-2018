...
<div class="book-now-cta" style="padding-bottom:40px;">
    <h1 class="cta-content"><?php the_field( 'title_2' ); ?></h1>
    <p><?php the_field( 'intro' ); ?></p>
</div>

<div class="core-values" style="padding-top:0px;">
    <?php 
        $row = array();
        $row = get_field( 'row' ); 
        ...
        <div class="core-values__section">
