  ...
  $custom_settings = array(
    ...
    'settings'        => array(
      ...
      array(
        ...
        'id'          => 'fb_access_token',
        'type'        => 'text',
        'desc'        => 'Visit <a href="http://logicum.co/getting-a-facebook-page-permanent-access-token/">http://logicum.co/getting-a-facebook-page-permanent-access-token/</a> for how to create a permanent token (in the API explorer, set the proper app, and create a token only for user_likes)',
        'section'     => 'misc'
      ),
      array(
        'id'          => 'misc_tab6',
        'label'       => 'Create Adtl. Sidebars',
        'type'        => 'tab',
        'section'     => 'misc'
      ),
      array(
      ...
      array(
        ...
        <ul>
         ...
         <li>- If the demo content fails, or hangs, please see this <a href="https://fuelthemes.ticksy.com/article/2706/" target="_blank">article</a></li>
        </ul>
        <br /><br />
	    ...
	    echo '<div class="format-setting type-colorpicker has-desc format-settings">';
	      ...
	      echo '<div class="format-setting-inner">'; 
	        ...
	        echo '<div class="option-tree-ui-colorpicker-input-wrap">';
	          ...
	          /* input */
	          echo '<input type="text" name="' . esc_attr( $field_name ) . '" id="' . esc_attr( $field_id ) . '" value="' . esc_attr( $field_value[$category->term_id] ) . '" class="hide-color-picker ' . esc_attr( $field_class ) . '" ' . $std . ' />';
