...
//include_once( 'inc/hp-2018/vc-shortcodes.php' );
...
function hp_page_meta() {
  ...
  // Body Class
  if ( get_field( 'pmv_body_class', $post_id ) ) {
...
function hp_enqueue_scripts() {
  ...
  if ( hp_page_type() == '2018' ) {
    ...
    wp_enqueue_script( 'vwo_smart_code', get_template_directory_uri() . '/assets/js/vwo_smart_code.js', 0, 0, 0 );
        ...
        wp_enqueue_script( 'auth', get_template_directory_uri() . '/assets/js/plugins/hmpl-auth.js', 0, 0, 1 );
    ...
    //wp_enqueue_script( 'foundation-js', get_template_directory_uri() . '/assets/foundation/js/foundation.min.js', 0, 0, 1 );
    //wp_enqueue_script( 'foundation-app', get_template_directory_uri() . '/assets/foundation/js/foundation-app.js', 0, 0, 1 );
  }
}
