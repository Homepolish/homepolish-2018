...
<div class="concierge-mobile">
	<div class="client-logos partners">
		...
		</div><div class="owl-carousel" data-owl-carousel><div class="logos-card"><?php 
	...
	<?php $brand = $value['pb_brand_image']; ?>
		<div class="logo-img-container">
			<img alt="The logo of Homepolish partner <?php echo get_the_title( $brand->ID ); ?>" class="logo-img" src="<?php echo get_the_post_thumbnail_url( $brand->ID ); ?>"></div><?php if ( $i % 3 == 0 ) { ?></div><div class="logos-card"><?php } 
