  ...
  private $in_sub_menu = 0;
	...
	*/
	function start_lvl(&$output, $depth = 0, $args = array()) {
	  ...
	  if($depth === 0) $output .= "\n{replace_one}\n";
    if($this->mega_menu_content === NULL) {
      $cat_label = "Interior Design By The Hour";
      $this->menu_cat = "service";
    } else {
      $cat_label = "Categories";
      $this->menu_cat = "magazine";
    }
	  $output .= "\n$indent<ul class=\"sub-menu ".(($depth === 0) ? "{locate_class}": "")."\"><!--<h4>".$cat_label."</h4>--><aside class=\"styled_dividers style-full-width-header no-margin\"></aside>\n";
	}
	...
	*/
	  ...
	  if($depth === 0 && $this->active_megamenu) {
		...
		if($depth === 0) {
			if($this->active_megamenu) {
				$output = str_replace("{replace_one}", '<div class="thb_mega_menu_holder '.$this->menu_cat.'"><div class="row"><div class="small-12 columns">', $output);
    ...
    $item_output .= '<a'. $attributes .' class="tertiary">';
