...
<div class="row">
    <div class="small-12 columns">
        <div class="row hero hero-feature" data-equalizer>
                    ...
                    <div class="table-cell">
                        ...
                        <?php
                            ...
                            if($designer_name && $designer_slug) { ?>
                                <p><span ="meta-key">Designer: </span><a href="<?php echo get_term_link($designer_slug, 'designer') ?>" class="secondary"><?php echo $designer_name; ?></a></p>
                            <?php }
                        ?>
                        <?php 
                            //City
                            ...
                            if( $location_name && $location_slug ) { ?>
                                <p><span ="meta-key">City: </span><a href="<?php echo get_term_link($location_slug, 'location') ?>" class="secondary"><?php echo $location_name; ?></a></p>
                            <?php }   
                        ?>
                    </div>
                </div>
