<article itemscope itemtype="http://schema.org/BlogPosting" <?php post_class('post style3-small'); ?> id="post-<?php the_ID(); ?>" role="article">
	...
	<figure class="post-gallery <?php do_action('thb_is_gallery'); ?>">
		<?php
			...
			$image = aq_resize( $image_link[0], 540, 280, true, false, true);  // Blog
