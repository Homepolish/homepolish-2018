<article itemscope itemtype="http://schema.org/BlogPosting" <?php post_class('post style3'); ?> id="post-<?php the_ID(); ?>" role="article">
	...
	<figure class="post-gallery <?php do_action('thb_is_gallery'); ?>">
		<?php
			...
			if ($featuredImage) {
				...
				$image = aq_resize( $image_link[0], 570, 380, true, false, true);
			}
