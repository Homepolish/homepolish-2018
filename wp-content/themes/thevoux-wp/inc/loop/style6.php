<!-- style6.php -->
<article itemscope itemtype="http://schema.org/BlogPosting" <?php post_class('post style6'); ?> id="post-<?php the_ID(); ?>" role="article">
	...
	<figure class="post-gallery <?php do_action('thb_is_gallery'); ?>">
		<?php
		    ...
		    $image_title = esc_attr( get_the_title($image_id) );
				...
				$image = aq_resize( $image_link[0], 540, 360, true, false, true);
		?>
