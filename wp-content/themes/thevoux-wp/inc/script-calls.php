...
function thb_register_js() {
	...
	if ( ! is_admin() && hp_page_type() == 'mag' ) {
		...
		wp_register_script('vendor', THB_THEME_ROOT . '/assets/js/vendor.min.js', 'jquery', version_id(), TRUE);
		wp_register_script('app', THB_THEME_ROOT . "/assets/js/app.min.js", 'jquery', version_id(), TRUE);
